(() => {
    ...
    da.init();
    let nums = document.getElementsByClassName("cooperation__list-text");
    let num_len = document.getElementsByClassName("cooperation__list-text").length;
    console.log(num_len);
    for (let index = 0; index < nums.length; index++) {
        let element = nums[index];
        let ind = index + 1;
        console.log(element);
        element.insertAdjacentHTML("beforebegin", "<p>" + ind + "</p>");
    }
    window["FLS"] = true;
    isWebp();
    menuInit();
